...
public class Anagramclass {
                ...
                public static class AnagramMapper extends Mapper<Object, Text, Text, Text> {
                         ...
                         //       @Override
                                public void map(Object key, Text value, Reporter reporter,Context context)throws IOException {
...
/*                                private Text outputKey = new Text();
                       ...
                       //         @Override
                                public void reduce(Text anagramKey, Iterator<Text> anagramValues,
                                                                OutputCollector<Text, Text> results, Reporter reporter, Context context)
                                                                throws IOException {
/*                                                String output = "";
